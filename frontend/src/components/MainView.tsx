            ...
            {mobileAppEnabled && (
              <div className="settings-section">
                ...
                {(currentUser?.isAdmin || !authEnabled) ? (
                  <>
                    {mobileApkAvailable ? (
                      <a href={api.APK_DOWNLOAD_URL} className="btn-sm btn-sm-primary" style={{ marginTop: '0.5rem' }} download="gantt-chart.apk">{isNativeApp ? 'Update app' : 'Download Android app (APK)'}</a>
                    ) : (
